    ...
    <section class="error-404-section">
        <div class="container error-container">
            ...
            <div class="error-content reveal-element" style="transition-delay: 0.2s;">
                ...
                <h2 class="error-title"><?php echo esc_html(abc_tech_tr('Oops! Rota não encontrada.')); ?></h2>
                <p class="error-description">
                    <?php echo esc_html(abc_tech_tr('Parece que você tentou acessar um endpoint que não existe. A página pode ter sido movida, excluída ou talvez você tenha digitado a URL incorretamente.')); ?>
                </p>
                ...
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="btn btn-primary btn-home">
                    ...
                    <?php echo esc_html(abc_tech_tr('Voltar para a Home')); ?>
                </a>
            </div>
            ...
            <div class="terminal-window reveal-element">
                ...
                <div class="terminal-body">
                    <p><span class="prompt">~</span> curl -I https://<?php echo esc_html(wp_parse_url(home_url(), PHP_URL_HOST)); ?>/endpoint</p>
